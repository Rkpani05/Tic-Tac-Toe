...
Label(root,text="Player 1 :",fg="blue",font=("Courier",10,"bold")).place(x=140,y=50)
p1 = Entry(root)
p1.place(x=230,y=52)

Label(root,text="Player 2 :",fg="blue",font=("Courier",10,"bold")).place(x=140,y=75)
p2 = Entry(root)
p2.place(x=230,y=77)

start = Button(root,text="START",bg="gray90",fg="green",font=("Ubuntu",15,"bold"),command=Start)
start.place(x=200,y=410)

turn = Label(root,text="",font=("Ubuntu",15,"normal"))
turn.place(x=230,y=455)
